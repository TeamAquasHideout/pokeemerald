...
static void SetPickupItem(void)
{
    ...
    randSeed = (u32)gSaveBlock1Ptr->frontier.pyramidRandoms[randSeedIndex + 1] << 16;
    randSeed |= gSaveBlock1Ptr->frontier.pyramidRandoms[randSeedIndex];
...
void GenerateBattlePyramidWildMon(void)
{
    ...
    u16 round = (gSaveBlock1Ptr->frontier.pyramidWinStreaks[lvl] / 7) % TOTAL_PYRAMID_ROUNDS;
