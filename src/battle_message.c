...
static const u8 sText_ItemsCantBeUsedNow[] = _("Items can't be used now.{PAUSE_UNTIL_PRESS}");
...
static const u8 sText_ButNothingHappened[] = _("But nothing happened!{PAUSE 32}");
static const u8 sText_ButItFailed[] = _("But it failed!{PAUSE 32}");
