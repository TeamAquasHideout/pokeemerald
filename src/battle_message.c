...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_ATTACKMISSED]                         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s attack missed!{PAUSE 32}"),
    ...
    [STRINGID_BUTNOTHINGHAPPENED]                   = COMPOUND_STRING("But nothing happened!{PAUSE 32}"),
    [STRINGID_BUTITFAILED]                          = COMPOUND_STRING("But it failed!{PAUSE 32}"),
    [STRINGID_ITHURTCONFUSION]                      = COMPOUND_STRING("It hurt itself in its confusion!{PAUSE 32}"),
...
static const u8 gRandomTrainerNamesF[][50] =
{
    _("Rose"),
    _("Gabby"),
    _("Brittney"),
    ...
    while (*src != EOS)
    {
        ...
        if (*src == PLACEHOLDER_BEGIN)
        {
            ...
            case B_TXT_TRAINER1_LOSE_TEXT: // trainerA lose text
                ...
                {
                    toCpy = GetTrainerALoseText(TRAINER_BATTLE_PARAM.opponentA); // Check Here
                }
                break;
            ...
            case B_TXT_TRAINER2_LOSE_TEXT:
                ...
                {
                    toCpy = GetTrainerBLoseText(TRAINER_BATTLE_PARAM.opponentB);
                }
                break;
