...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_EDWIN] = REMATCH(TRAINER_EDWIN_1, TRAINER_RANDOM_BATTLE_1, TRAINER_RANDOM_BATTLE_2, TRAINER_RANDOM_PIT_BOSS, TRAINER_RANDOM_PIT_BOSS_DOUBLES, MAP_ROUTE110),
