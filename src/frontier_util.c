...
static void SaveSelectedParty(void)
{
    ...
    for (i = 0; i < MAX_FRONTIER_PARTY_SIZE; i++)
    {
        ...
        if (monId < PARTY_SIZE)
            SavePlayerPartyMon(gSaveBlock1Ptr->frontier.selectedPartyMons[i] - 1, &gPlayerParty[i]);
    }
}
...
static void RestoreHeldItems(void)
{
    ...
    for (i = 0; i < MAX_FRONTIER_PARTY_SIZE; i++)
    {
        ...
        {
            u16 item = GetMonData(GetSavedPlayerPartyMon(gSaveBlock1Ptr->frontier.selectedPartyMons[i] - 1), MON_DATA_HELD_ITEM, NULL);
    ...
    for (i = 0; i < MAX_FRONTIER_PARTY_SIZE; i++)
    {
        ...
        if (monId < PARTY_SIZE)
        {
            for (j = 0; j < MAX_MON_MOVES; j++)
            {
                ...
                {
                    if (GetMonData(GetSavedPlayerPartyMon(gSaveBlock1Ptr->frontier.selectedPartyMons[i] - 1), MON_DATA_MOVE1 + k, NULL)
