...
{
    [POCKET_ITEMS] =        COMPOUND_STRING("STATUS"),
    [POCKET_MEDICINE] =     COMPOUND_STRING("HP & PP"),
    [POCKET_POKE_BALLS] =        COMPOUND_STRING("REVIVES"),
...
const u8 gText_NumberItem_HM[] = _("{STR_VAR_2}");
