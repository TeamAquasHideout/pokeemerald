...
const u8 gText_LeagueChamp[] = _("THE PIT CHAMPION!\nCONGRATULATIONS!                   v2.4.2 Gen3");
const u8 gText_LostRunChamp[] = _("Good Progress!\nand Good Luck Next Time!         v2.4.2 Gen3");
#endif
#ifdef PIT_GEN_5_MODE
const u8 gText_LeagueChamp[] = _("THE PIT CHAMPION!\nCONGRATULATIONS!                   v2.4.2 Gen5");
const u8 gText_LostRunChamp[] = _("Good Progress!\nand Good Luck Next Time!         v2.4.2 Gen5");
#endif
#ifdef PIT_GEN_9_MODE
const u8 gText_LeagueChamp[] = _("THE PIT CHAMPION!\nCONGRATULATIONS!                   v2.4.2 Gen9");
const u8 gText_LostRunChamp[] = _("Good Progress!\nand Good Luck Next Time!         v2.4.2 Gen9");
#endif
...
const u8 gText_CantUseEscapeRope[] = _("It failed!\pIt seems there's no escape from\nThe Pit...{PAUSE_UNTIL_PRESS}");
...
const u8 gText_WhichOneWillYouTake[] = _("Can't Withdraw More");
...
const u8 gText_WithdrawMonDescription[] = _("Take a single Pokémon with you.\nLevels and EVs will be reduced.");
const u8 gText_DepositMonDescription[] = _("Save your winning team in your box\nafter completing a run in The Pit.");
const u8 gText_MoveMonDescription[] = _("Organize your winning Pokémon\nin your Boxes.");
const u8 gText_MoveItemsDescription[] = _("Move items held by any POKéMON\nin a BOX or your party.");
const u8 gText_SeeYaDescription[] = _("Close the PC.");
const u8 gText_JustOnePkmn[] = _("There are no POKéMON with you.");
