...
static void Task_ShowResetRtcPrompt(u8 taskId)
{
    ...
    case 0:
        ...
        PrintTime(
            ...
            0,
            49,
            0,//gSaveBlock2Ptr->lastBerryTreeUpdate.days,
            0,//gSaveBlock2Ptr->lastBerryTreeUpdate.hours,
            0,//gSaveBlock2Ptr->lastBerryTreeUpdate.minutes,
            0//gSaveBlock2Ptr->lastBerryTreeUpdate.seconds
            );
