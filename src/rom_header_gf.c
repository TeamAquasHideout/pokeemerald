...
__attribute__((section(".text.header_gf"))) USED static const struct GFRomHeader sGFRomHeader = {
    ...
    .seen1Offset = offsetof(struct SaveBlock2, dexSeen),
    .seen2Offset = offsetof(struct SaveBlock2, dexSeen), // dex flags are combined, just provide the same pointer
    ...
    .gcnLinkFlagsOffset = offsetof(struct SaveBlock2, statsRunKOs),
