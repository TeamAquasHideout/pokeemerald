...
{
    [MAPSEC_PIT_ENTRANCE] = {MAP_GROUP(MAP_LITTLEROOT_TOWN), MAP_NUM(MAP_LITTLEROOT_TOWN), HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F},
    [MAPSEC_PIT_FLOORS] = {MAP_GROUP(MAP_OLDALE_TOWN), MAP_NUM(MAP_OLDALE_TOWN), HEAL_LOCATION_OLDALE_TOWN},
    [MAPSEC_PIT_REST_FLOOR] = {MAP_GROUP(MAP_DEWFORD_TOWN), MAP_NUM(MAP_DEWFORD_TOWN), HEAL_LOCATION_DEWFORD_TOWN},
    [MAPSEC_PIT_BOSS] = {MAP_GROUP(MAP_LAVARIDGE_TOWN), MAP_NUM(MAP_LAVARIDGE_TOWN), HEAL_LOCATION_LAVARIDGE_TOWN},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_PIT_ENTRANCE:
        return FlagGet(FLAG_VISITED_LITTLEROOT_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_PIT_FLOORS:
...
static void CreateFlyDestIcons(void)
{
    ...
    for (mapSecId = MAPSEC_PIT_ENTRANCE; mapSecId <= MAPSEC_EVER_GRANDE_CITY; mapSecId++)
    {
