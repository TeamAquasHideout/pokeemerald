...
static const u8 sText_EVO_DAMAGE_TAKEN[] = _("{LV}{UP_ARROW} with {STR_VAR_2} damage taken");
...
static void PrintStatsScreen_Moves_Top(u8 taskId)
{
    ...
    {
        level = GetSpeciesLevelUpLearnset(species)[(selected - numEggMoves - numPreEvoMoves)].level;
...
static void PrintStatsScreen_Abilities(u8 taskId)
{
    ...
    if (gTasks[taskId].data[5] == 0)
    {
        ...
        PrintStatsScreenTextSmall(WIN_STATS_ABILITIES, gAbilitiesInfo[ability0].description_short, abilities_x, abilities_y + 14);
        ...
        if (ability1 != ABILITY_NONE && ability1 != ability0)
        {
            ...
            PrintStatsScreenTextSmall(WIN_STATS_ABILITIES, gAbilitiesInfo[ability1].description_short, abilities_x, abilities_y + 44);
        }
    }
    else //Hidden abilities
    {
        ...
        PrintStatsScreenTextSmall(WIN_STATS_ABILITIES, gAbilitiesInfo[abilityHidden].description_short, abilities_x, abilities_y + 14);
    }
}
...
static void PrintEvolutionTargetSpeciesAndMethod(u8 taskId, u16 species, u8 depth, u32 *depth_i, u32 alreadyPrintedIcons[], u32 *icon_depth_i)
{
    ...
    for (i = 0; i < times; i++)
    {
        ...
        case EVO_DAMAGE_TAKEN:
            ConvertIntToDecimalStringN(gStringVar2, evolutions[i].param, STR_CONV_MODE_LEADING_ZEROS, 2);
            StringExpandPlaceholders(gStringVar4, sText_EVO_DAMAGE_TAKEN);
            break;
