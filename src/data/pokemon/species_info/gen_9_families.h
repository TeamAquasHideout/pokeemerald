...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_PAWMO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_PAWMOT, CONDITIONS({IF_MIN_OVERWORLD_STEPS, 1000})},
                                {EVO_ITEM, ITEM_RUNNING_SHOES, SPECIES_PAWMOT}),
    },
    ...
    [SPECIES_TANDEMAUS] =
    {
        ...
        .abilities = { ABILITY_RUN_AWAY, ABILITY_NONE, ABILITY_OWN_TEMPO },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_BRAMBLIN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_BRAMBLEGHAST, CONDITIONS({IF_MIN_OVERWORLD_STEPS, 1000})},
                                {EVO_ITEM, ITEM_RUNNING_SHOES, SPECIES_BRAMBLEGHAST}),
    },
    ...
    [SPECIES_RELLOR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_RABSCA, CONDITIONS({IF_MIN_OVERWORLD_STEPS, 1000})},
                                {EVO_ITEM, ITEM_RUNNING_SHOES, SPECIES_RABSCA}),
    },
    ...
    [SPECIES_GIMMIGHOUL_CHEST] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_GHOLDENGO, CONDITIONS({IF_HOLD_ITEM, ITEM_GIMMIGHOUL_COIN})}),
    },
