...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_PIKACHU] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU_ALOLA, CONDITIONS({IF_HOLD_ITEM, ITEM_PSYCHIC_MEMORY})},
    ...
    [SPECIES_PIKACHU_HOENN] = //updated to partner Pickachu stats
    {
        .baseHP        = 45,
        .baseAttack    = 80,
        .baseDefense   = 50,
        ...
        OVERWORLD(
            ...
            TRACKS_FOOT,
            sAnimTable_Following,
            gOverworldPalette_PikachuHoennCap,
            gShinyOverworldPalette_PikachuHoennCap
        )
        FOOTPRINT(Pikachu)
        .levelUpLearnset = sPikachuLevelUpLearnset,
        .teachableLearnset = sPikachuTeachableLearnset,
...
#define WIGGLYTUFF_SP_ATK   50
    ...
    [SPECIES_MEOWTH_ALOLA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_PERSIAN_ALOLA, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD})},
                                {EVO_ITEM, ITEM_RUNNING_SHOES, SPECIES_PERSIAN_ALOLA}),
    },
    ...
    [SPECIES_MEOWTH_GALAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_NONE, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Meowth"),
        .cryId = CRY_MEOWTH,
        .natDexNum = NATIONAL_DEX_MEOWTH,
...
#define GOLEM_ATTACK (P_UPDATED_STATS >= GEN_6 ? 120 : 110)
    ...
    [SPECIES_SLOWPOKE_GALAR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_GALARICA_CUFF, SPECIES_SLOWBRO_GALAR}
                            #if P_GEN_2_CROSS_EVOS
                                ,{EVO_ITEM, ITEM_GALARICA_WREATH, SPECIES_SLOWBRO_GALAR}
                            #endif
                            ),
    },
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_EXEGGCUTE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR_ALOLA, CONDITIONS({IF_HOLD_ITEM, ITEM_DRAGON_MEMORY})},
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_MAROWAK_ALOLA, CONDITIONS({IF_HOLD_ITEM, ITEM_GHOST_MEMORY})},
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_WEEZING_GALAR, CONDITIONS({IF_HOLD_ITEM, ITEM_FAIRY_MEMORY})},
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_MR_MIME, CONDITIONS({IF_KNOWS_MOVE, MOVE_MIMIC})},
                                {EVO_LEVEL, 0, SPECIES_MR_MIME_GALAR, CONDITIONS({IF_HOLD_ITEM, ITEM_ICE_MEMORY})}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_EEVEE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            ...
                            #if defined(PIT_GEN_5_MODE) || defined(PIT_GEN_9_MODE)
