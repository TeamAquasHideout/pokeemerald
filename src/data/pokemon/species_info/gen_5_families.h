...
#include "config/general.h"
    ...
    [SPECIES_DEWOTT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_SAMUROTT_HISUI, CONDITIONS({IF_HOLD_ITEM, ITEM_DARK_MEMORY})},
    ...
    [SPECIES_WOOBAT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_SWOOBAT, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD})},
                                {EVO_ITEM, ITEM_RUNNING_SHOES, SPECIES_LEAVANNY}),
    },
    ...
    [SPECIES_PETILIL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT_HISUI, CONDITIONS({IF_HOLD_ITEM, ITEM_FIGHTING_MEMORY})},
    ...
    [SPECIES_RUFFLET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 54, SPECIES_BRAVIARY_HISUI, CONDITIONS({IF_HOLD_ITEM, ITEM_PSYCHIC_MEMORY})},
