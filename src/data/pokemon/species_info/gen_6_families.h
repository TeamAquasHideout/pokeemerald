...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_SLIGGOO_HISUI, CONDITIONS({IF_HOLD_ITEM, ITEM_STEEL_MEMORY})},
    ...
    [SPECIES_BERGMITE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_AVALUGG_HISUI, CONDITIONS({IF_HOLD_ITEM, ITEM_ROCK_MEMORY})},
