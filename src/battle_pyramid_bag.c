...
static void PrintItemDescription(s32 listMenuId)
{
    ...
    {
        desc = GetItemDescription(gSaveBlock1Ptr->frontier.pyramidBag.itemId[gSaveBlock1Ptr->frontier.lvlMode][listMenuId]);
    }
    else
    {
...
static void LoadPyramidBagPalette(void)
{
    ...
    spritePalette.data = gBattlePyramidBag_Pal + PLTT_ID(gSaveBlock1Ptr->frontier.lvlMode);
