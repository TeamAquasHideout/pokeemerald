...
static const u16 ObjectEventToTrainerPic [] =
{
    ...
    [OBJ_EVENT_GFX_GIRL_2]      =   TRAINER_PIC_SCHOOL_KID_F,
    [OBJ_EVENT_GFX_LITTLE_BOY]  =   TRAINER_PIC_SCHOOL_KID_M,
    [OBJ_EVENT_GFX_LITTLE_GIRL] =   TRAINER_PIC_SCHOOL_KID_F,
    [OBJ_EVENT_GFX_BOY_3]       =   TRAINER_PIC_YOUNGSTER,
    [OBJ_EVENT_GFX_GIRL_3]      =   TRAINER_PIC_SCHOOL_KID_F,
    [OBJ_EVENT_GFX_RICH_BOY]    =   TRAINER_PIC_RICH_BOY,
    [OBJ_EVENT_GFX_WOMAN_1]     =   TRAINER_PIC_LADY,
    [OBJ_EVENT_GFX_FAT_MAN]     =   TRAINER_PIC_POKEMON_BREEDER_M,
    [OBJ_EVENT_GFX_POKEFAN_F]   =   TRAINER_PIC_POKEFAN_F,
    [OBJ_EVENT_GFX_MAN_1]       =   TRAINER_PIC_POKEMANIAC,
    [OBJ_EVENT_GFX_WOMAN_2]     =   TRAINER_PIC_LADY,
    [OBJ_EVENT_GFX_EXPERT_M]    =   TRAINER_PIC_EXPERT_M,
    [OBJ_EVENT_GFX_EXPERT_F]    =   TRAINER_PIC_EXPERT_F,
    [OBJ_EVENT_GFX_MAN_2]       =   TRAINER_PIC_POKEFAN_M,
    [OBJ_EVENT_GFX_WOMAN_3]     =   TRAINER_PIC_AROMA_LADY,
    [OBJ_EVENT_GFX_POKEFAN_M]   =   TRAINER_PIC_POKEFAN_M,
    [OBJ_EVENT_GFX_WOMAN_4]     =   TRAINER_PIC_LADY,
    [OBJ_EVENT_GFX_COOK]        =   TRAINER_PIC_POKEMANIAC,
    [OBJ_EVENT_GFX_LINK_RECEPTIONIST] = TRAINER_PIC_LADY,
    [OBJ_EVENT_GFX_OLD_MAN]     =   TRAINER_PIC_GENTLEMAN,
    [OBJ_EVENT_GFX_OLD_WOMAN]   =   TRAINER_PIC_LADY,
    [OBJ_EVENT_GFX_CAMPER]      =   TRAINER_PIC_CAMPER,
    [OBJ_EVENT_GFX_PICNICKER]   =   TRAINER_PIC_PICNICKER,
    [OBJ_EVENT_GFX_MAN_3]       =   TRAINER_PIC_BIRD_KEEPER,
    [OBJ_EVENT_GFX_WOMAN_5]     =   TRAINER_PIC_AROMA_LADY,
    ...
    [OBJ_EVENT_GFX_ANABEL]      =   TRAINER_PIC_AROMA_LADY,
    ...
    [OBJ_EVENT_GFX_SCIENTIST_1] =   TRAINER_PIC_POKEMANIAC,
