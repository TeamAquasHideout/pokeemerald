...
{
    { COMPOUND_STRING("Clear Current Floor"),   DebugAction_ExecuteScript, Debug_EventScript_Script_1 },
    { COMPOUND_STRING("Floor 25 (No Candy)"),   DebugAction_ExecuteScript, Debug_EventScript_Script_2 },
    { COMPOUND_STRING("Advance To Archie"),     DebugAction_ExecuteScript, Debug_EventScript_Script_3 },
    { COMPOUND_STRING("Show HoF screen"),       DebugAction_ExecuteScript, Debug_EventScript_Script_4 },
    { COMPOUND_STRING("Floor 10 (Move Tutor)"), DebugAction_ExecuteScript, Debug_EventScript_Script_5 },
    { COMPOUND_STRING("Give 3 Lvl 100s"),       DebugAction_ExecuteScript, Debug_EventScript_Script_6 },
    { COMPOUND_STRING("Floor 50 (+ Candy)"),    DebugAction_ExecuteScript, Debug_EventScript_Script_7 },
    { COMPOUND_STRING("Mon Encounter Floor"),   DebugAction_ExecuteScript, Debug_EventScript_Script_8 },
    { NULL }
};
