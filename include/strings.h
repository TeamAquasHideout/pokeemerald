...
extern const u8 gText_Dash_Space[];
...
extern const u8 gText_CantUseEscapeRope[];
...
extern const u8 gText_AereonApproach[];
extern const u8 gText_AaronApproach[];
extern const u8 gText_BlakeApproach[];
extern const u8 gText_CollinApproach[];
extern const u8 gText_DyllanApproach[];
extern const u8 gText_ElaineApproach[];
extern const u8 gText_FreddyApproach[];
extern const u8 gText_Grace2Approach[];
extern const u8 gText_HelenaApproach[];
extern const u8 gText_IanApproach[];
extern const u8 gText_JohnApproach[];
extern const u8 gText_KiraApproach[];
extern const u8 gText_LindseyApproach[];
extern const u8 gText_MichaelApproach[];
extern const u8 gText_Nathan2Approach[];
extern const u8 gText_OliviaApproach[];
extern const u8 gText_PaulApproach[];
extern const u8 gText_QuinnApproach[];
extern const u8 gText_RileyApproach[];
extern const u8 gText_StephenApproach[];
extern const u8 gText_TrevorApproach[];
extern const u8 gText_VictorApproach[];
extern const u8 gText_ShawnApproach[];
extern const u8 gText_NewApproach01[];
extern const u8 gText_NewApproach02[];
extern const u8 gText_NewApproach03[];
extern const u8 gText_NewApproach04[];
extern const u8 gText_NewApproach05[];
extern const u8 gText_NewApproach06[];
extern const u8 gText_NewApproach07[];
extern const u8 gText_NewApproach08[];
extern const u8 gText_NewApproach09[];
extern const u8 gText_NewApproach10[];
extern const u8 gText_NewApproach11[];
extern const u8 gText_NewApproach12[];
extern const u8 gText_NewApproach13[];
extern const u8 gText_NewApproach14[];
extern const u8 gText_NewApproach15[];
extern const u8 gText_NewApproach16[];
extern const u8 gText_NewApproach17[];
extern const u8 gText_NewApproach18[];
extern const u8 gText_NewApproach19[];
extern const u8 gText_NewApproach20[];
...
extern const u8 gText_wiz1989Defeat[];
extern const u8 gText_AereonDefeat[];
extern const u8 gText_AaronDefeat[];
extern const u8 gText_BlakeDefeat[];
extern const u8 gText_CollinDefeat[];
extern const u8 gText_DyllanDefeat[];
extern const u8 gText_ElaineDefeat[];
extern const u8 gText_FreddyDefeat[];
extern const u8 gText_Grace2Defeat[];
extern const u8 gText_HelenaDefeat[];
extern const u8 gText_IanDefeat[];
extern const u8 gText_JohnDefeat[];
extern const u8 gText_KiraDefeat[];
extern const u8 gText_LindseyDefeat[];
extern const u8 gText_MichaelDefeat[];
extern const u8 gText_Nathan2Defeat[];
extern const u8 gText_OliviaDefeat[];
extern const u8 gText_PaulDefeat[];
extern const u8 gText_QuinnDefeat[];
extern const u8 gText_RileyDefeat[];
extern const u8 gText_StephenDefeat[];
extern const u8 gText_TrevorDefeat[];
extern const u8 gText_VictorDefeat[];
extern const u8 gText_ShawnDefeat[];
