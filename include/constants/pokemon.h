...
// Shiny odds
#define SHINY_ODDS 50 // Actual probability is SHINY_ODDS/65536
...
#define EV_ITEM_RAISE_LIMIT MAX_PER_STAT_EVS//((I_VITAMIN_EV_CAP >= GEN_8) ? MAX_PER_STAT_EVS : 100)
