...
#define FLAG_TRAINER_EVS     0x24 // Have trainer EVs matching the player's teams's average EVs
...
#define FLAG_CASE_TRADE_MODE    0x31 // Unused Flag
...
#define FLAG_MIXED_MODE      0x40 // Unused Flag
